#############################################################################################################################################################################
## SKEMA DATA FROM FIRESTORE (SKIP THIS ENTIRE COMMENTS IF YOU DON'T WANT TO USE FIREBASE)
#############################################################################################################################################################################
...
# # Firestore
# cred = credentials.Certificate("bumi-api-4e903-firebase-adminsdk-75pgu-b7278330a6.json")
...
############################################################################################################################################################################
#SKEMA DATA FROM CSV (CODE STARTS HERE FOR DEMO SCHEME)
############################################################################################################################################################################
from uuid import uuid4
from fastapi import FastAPI
from fastapi.responses import RedirectResponse, JSONResponse, Response
